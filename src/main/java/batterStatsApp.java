...
public class batterStatsApp extends Application {
    ...
    public Scene createReportScene() {
        ...
        Button reportTeamField = new Button ("Team Field");
    ...
    private void enterInfo() {
        ...
        // check if the batters team is currently in the database or not
        // if not, add the team first
        int teamExists = BatterAppDB.getTeamIDFromTeamName(batterTeam);
        if (teamExists == 999) {
